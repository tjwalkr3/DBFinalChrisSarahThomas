...
INSERT INTO airline_booking.scheduled_flight (
    ...
    ('2024-08-16 13:15:00', '2024-08-16 19:30:00', 1, 1, 3, 1), -- 6hr 15min from JFK to SEA
...
INSERT INTO airline_booking.reservation (passenger_id, scheduled_flight_id, ticket_cost) VALUES 
    (1, 1, 200.00),
    (2, 1, 200.00),
    (3, 2, 150.00),
    (6, 5, 200.00),
...
INSERT INTO airline_booking.payment (reservation_id, amount) VALUES 
    (1, 400.00),
    (1, 3.99),
    (1, 5.78),
    (2, 200.00),
